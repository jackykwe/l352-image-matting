...
def downsample_image(I, antialiasing_filter_size):
    ...
    Returns: ceil((H - 2 * antialiasing_filter_size) / 2) x ceil((W - 2 * antialiasing_filter_size) / 2) x C array
    """
...
def upsample_image(I, new_H, new_W, reconstruction_filter_size=1):
    ...
    `I`: ceil((H - 2 * antialiasing_filter_size) / 2) x ceil((W - 2 * antialiasing_filter_size) / 2) x C array

    Returns: H x W x C array
